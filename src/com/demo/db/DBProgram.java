...
public class DBProgram {
	...
	public void getTableName(String schema,String exportFilePath,String outPutTypeSelected) throws SQLException {
		...
		ExportDBMetadata.exportListIntoExcel(columndataList,exportFilePath,outPutTypeSelected);
